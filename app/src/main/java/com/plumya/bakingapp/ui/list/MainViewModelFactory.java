 ...
 * {@link com.plumya.bakingapp.data.BakingRepository}
 */
public class MainViewModelFactory extends ViewModelProvider.NewInstanceFactory {

    private final BakingRepository bakingRepository;

    public MainViewModelFactory(BakingRepository bakingRepository) {
    ...
    public <T extends ViewModel> T create(Class<T> modelClass) {
        ...
        return (T) new MainActivityViewModel(bakingRepository);
    }
}